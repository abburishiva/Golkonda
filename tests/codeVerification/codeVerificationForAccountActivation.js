...
describe("CODE_VERIFICATION_FOR_ACCOUNT_ACTIVATION", function () {
    var testSuite = this.title,
        testSuiteData = {};
    /*it("TEST_FOR_NEW_USER", function (done) {
    ...
    it("TEST_FOR_NEW_USER_WITH_EXCESS_CODE_LENGTH", function (done) {
        var testCase = this.test.title,
            testCaseData = data[testSuite][testCase];
        this.timeout(50000);
        return chakram.post(url, testCaseData.input).then(function (result) {
    ...
    it("TEST_FOR_NEW_USER_WITH_INSUFFICIENT_CODE_LENGTH", function (done) {
        var testCase = this.test.title,
            testCaseData = data[testSuite][testCase];
        this.timeout(50000);
        return chakram.post(url, testCaseData.input).then(function (result) {
    ...
    it("TEST_FOR_NEW_USER_WITH_INVALID_CODE", function (done) {
        var testCase = this.test.title,
            testCaseData = data[testSuite][testCase];
        this.timeout(50000);
        return chakram.post(url, testCaseData.input).then(function (result) {
    ...
    it("TEST_FOR_EXISTING_USER", function (done) {
        var testCase = this.test.title,
            testCaseData = data[testSuite][testCase];
        this.timeout(50000);
        return chakram.post(url, testCaseData.input).then(function (result) {
    ...
    it("TEST_FOR_EXISTING_USER_WITH_INVALID_CODE", function (done) {
        var testCase = this.test.title,
            testCaseData = data[testSuite][testCase];
        this.timeout(50000);
        return chakram.post(url, testCaseData.input).then(function (result) {
